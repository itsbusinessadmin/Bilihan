/* Bilihan — analytics loader.
   ...
   Loads nothing at all unless BILIHAN_CONFIG.ANALYTICS is configured. Page views
   plus two non-identifying events; no order details, customer names, phone
   numbers, or addresses are ever sent.

   Note: Plausible and Umami are cookieless and need no consent banner. GA4 sets
   cookies — if you switch to it and expect EU/UK visitors, you would also need a
   consent banner in front of it. */
(() => {
